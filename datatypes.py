...
#Number
"""
Integer -- which can represented as int() which holds all the positive and negative whole numbers
o to n and o to -n
...
"""
list is a collection of items/values/elements (mutable)
...
"""
Tuple -- Its a collection of items/values/elements(Immutable)
...
#using the indexing we can acess the elements(Index value always start with 0 and ends with n-1)
